    ...
    for fn in files:
        ...
        if "BJ_AWS" in fn:
            GRAD_BJ = pd.read_csv(path+fn, usecols=['Date/Time(BST)', 
                                                 ...
                                                 'WD_10.36m_10MinAve',
                                                 'Pressure_10MinAve',
                                                 'Precipitation_10minAcc'],low_memory=False)
            GRAD_BJ.to_csv(outpath+'FILD_BOUD_GRAD_MIN'+str(fr)+'_NAQ'+fn[-9:], encoding='utf-8', index=False)
            SOIL_BJ = pd.read_csv(path+fn, usecols = ['Date/Time(BST)', 
                                                   ...
                                                   'SHF_20cm_10MinAve', 
                                                   'Swc_4cm_10MinAve', 
                                                   'Swc_20cm_10MinAve'],low_memory=False)
            SOIL_BJ.to_csv(outpath+'FILD_BOUD_SOIL_MIN'+str(fr)+'_NAQ'+fn[-9:], encoding='utf-8', index=False)
            RADI_BJ = pd.read_csv(path+fn, usecols= ['Date/Time(BST)',
                                                  'Rsd_10MinAve', 
                                                  'Rsu_10MinAve', 
                                                  'Rld_10MinAve', 
                                                  'Rlu_10MinAve'],low_memory=False)
            RADI_BJ.to_csv(outpath+'FILD_BOUD_RADM_MIN'+str(fr)+'_NAQ'+fn[-9:], encoding='utf-8', index=False)
        ...
        #########################
            ...
            FLUX_BJ = pd.read_csv(path+fn, usecols = ['Date/Time', 
                                                    ...
                                                    'QA_H', 
                                                    'QA_LE', 
                                                    'QA_Fc'],low_memory=False)
            FLUX_BJ.to_csv(outpath+'FILD_BOUD_FLUX_MIN'+str(fr)+'_NAQ'+fn[-9:], encoding='utf-8', index=False)
        ...
        #########################
            ...
            GRAD_AMDO = pd.read_csv(path+fn, usecols=['Date/Time(BST)',
                                                     ...
                                                     'WD_12m_30MinAve', 
                                                     'Pressure_30MinAve', 
                                                     'Precipitation_30MinAcc'],low_memory=False)
            GRAD_AMDO.to_csv(outpath+'FILD_BOUD_GRAD_MIN'+str(fr)+'_AND'+fn[-9:], encoding='utf-8', index=False)
            SOIL_AMDO = pd.read_csv(path+fn, usecols = ['Date/Time(BST)',
                                                       ...
                                                       'Swc_40cm_30MinAve', 
                                                       'Swc_80cm_30MinAve', 
                                                       'Swc_160cm_30MinAve'],low_memory=False)
            SOIL_AMDO.to_csv(outpath+'FILD_BOUD_SOIL_MIN'+str(fr)+'_AND'+fn[-9:], encoding='utf-8', index=False)
            RADI_AMDO = pd.read_csv(path+fn, usecols= ['Date/Time(BST)',
                                                      'Rsd_30MinAve', 
                                                      'Rsu_30MinAve', 
                                                      'Rld_30MinAve', 
                                                      'Rlu_30MinAve'],low_memory=False)
            RADI_AMDO.to_csv(outpath+'FILD_BOUD_RADM_MIN'+str(fr)+'_AND'+fn[-9:], encoding='utf-8', index=False)
            ...
            SOIL_AMDO = pd.read_csv(path+fn, usecols = ['Date/Time(BST)',
                                                       ...
                                                       'Ts_20cm_30MinAve', 
                                                       'SHF_10cm_30MinAve', 
                                                       'SHF_20cm_30MinAve', ],low_memory=False)
            SOIL_AMDO.to_csv(outpath+'FILD_BOUD_SOIL_MIN'+str(fr)+'_AND'+fn[-9:], encoding='utf-8', index=False)
            RADI_AMDO = pd.read_csv(path+fn, usecols= ['Date/Time(BST)',
                                                      'Rsd_30MinAve', 
                                                      'Rsu_30MinAve', 
        ...
        #########################
            ...
            FLUX_AMDO = pd.read_csv(path+fn, usecols = ['Date/Time', 
                                                        ...
                                                        'QA_LE', 
                                                        'QA_Fc'],low_memory=False)
            FLUX_AMDO.to_csv(outpath+'FILD_BOUD_FLUX_MIN'+str(fr)+'_AND'+fn[-9:], encoding='utf-8', index=False)
        else :
